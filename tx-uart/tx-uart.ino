/////////////////////////////////////////////////////////////////////////////////////////////
// .___   _________   _____       _________ __________ ___________   _____ ______________________ 
// |   | /   _____/  /     \      \_   ___ \\______   \\_   _____/  /  _  \\__    ___/\_   _____/ 
// |   | \_____  \  /  \ /  \     /    \  \/ |       _/ |    __)_  /  /_\  \ |    |    |    __)_  
// |   | /        \/    Y    \    \     \____|    |   \ |        \/    |    \|    |    |        \ 
// |___|/_______  /\____|__  /     \______  /|____|_  //_______  /\____|__  /|____|   /_______  / 
//              \/         \/             \/        \/         \/         \/                  \/  
//
//   ______                                _ __  __               ____                 __                   
//  /_  __/________ _____  _________ ___  (_) /_/ /____  _____   / __ \___  ____ _____/ /_  __              
//   / / / ___/ __ `/ __ \/ ___/ __ `__ \/ / __/ __/ _ \/ ___/  / /_/ / _ \/ __ `/ __  / / / /              
//  / / / /  / /_/ / / / (__  ) / / / / / / /_/ /_/  __/ /     / _, _/  __/ /_/ / /_/ / /_/ /  _    _    _  
// /_/ /_/   \__,_/_/ /_/____/_/ /_/ /_/_/\__/\__/\___/_/     /_/ |_|\___/\__,_/\__,_/\__, /  (_)  (_)  (_)                                                                                   /____/                 
//                                                                                   /____/                 
//
// E F Halliwell
// Summer 2023
...
void setup() {
  ...
  Serial.println(".___   _________   _____       _________ __________ ___________   _____ ______________________ ");
  Serial.println("|   | /   _____/  /     \\      \\_   ___ \\\\______   \\\\_   _____/  /  _  \\\\__    ___/\\_   _____/ ");
  Serial.println("|   | \\_____  \\  /  \\ /  \\     /    \\  \\/ |       _/ |    __)_  /  /_\\  \\ |    |    |    __)_  ");
  Serial.println("|   | /        \\/    Y    \\    \\     \\____|    |   \\ |        \\/    |    \\|    |    |        \\ ");
  Serial.println("|___|/_______  /\\____|__  /     \\______  /|____|_  //_______  /\\____|__  /|____|   /_______  /");
  Serial.println("             \\/         \\/             \\/        \\/         \\/         \\/                  \\/  ");

  Serial.println("//   ______                                _ __  __               ____                 __                   ");
  Serial.println("//  /_  __/________ _____  _________ ___  (_) /_/ /____  _____   / __ \\___  ____ _____/ /_  __              ");
  Serial.println("//   / / / ___/ __ `/ __ \\/ ___/ __ `__ \\/ / __/ __/ _ \\/ ___/  / /_/ / _ \\/ __ `/ __  / / / /              ");
  Serial.println("//  / / / /  / /_/ / / / (__  ) / / / / / / /_/ /_/  __/ /     / _, _/  __/ /_/ / /_/ / /_/ /  _    _    _  ");
  Serial.println("// /_/ /_/   \\__,_/_/ /_/____/_/ /_/ /_/_/\\__/\\__/\\___/_/     /_/ |_|\\___/\\__,_/\\__,_/\\__, /  (_)  (_)  (_)");
  Serial.println("                                                                                   /____/                 ");
}
